...
export default function RegistrationForm() {
  ...
  const [regType, setRegType] = useState<"regular" | "diploma" | null>(null);
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        throw new Error(
          data.error || `Submission failed with status ${res.status}`,
        );
      }
    } catch (err: any) {
  ...
  const isStep1Valid = () => {
    return (
      team.teamName.trim().length >= 3 && team.collegeName.trim().length >= 3
    );
  };
  ...
  const isStep2Valid = () => {
    ...
    return (
      ...
      team.leader.department.trim().length >= 2 &&
      team.leader.year.trim().length > 0 &&
  ...
  const isStep3Valid = () => {
    ...
    return team.members.every(
      (member) =>
        ...
        phoneRegex.test(member.phone) &&
        member.department.trim().length >= 2 &&
        member.year.trim().length > 0,
    );
  };
    ...
    <div className="min-h-screen bg-[#0a0a0a] relative overflow-hidden">
          ...
          <div className="relative">
            ...
            >
              ...
              <p className="text-[#1a1206] font-bold text-sm leading-relaxed">
                {currentStep === 1 &&
                  "Rally your troops! Enter your team details to begin the quest."}
                {currentStep === 2 &&
                  "Every great team needs a fearless leader. Show us who commands this squad!"}
                {currentStep === 3 &&
                  "Assemble your warriors! The strongest clans have the mightiest members."}
                {currentStep === 4 &&
                  "Time to pay the entry toll! Scan, pay, and upload proof of your tribute."}
              </p>
            </motion.div>
          </div>
        </motion.div>
      ...
      {success && (
        <div className="relative z-10 container mx-auto px-4 py-8 min-h-screen flex flex-col items-center justify-center">
          <div
            className="w-full max-w-2xl bg-gradient-to-b from-[#1a1206] to-[#0a0a0a] rounded-xl shadow-2xl border-2 sm:border-4 border-[#4C1D00] p-6 sm:p-8 md:p-12 text-center animate-fadeIn"
            style={{
              boxShadow:
                "0 0 40px rgba(232, 192, 104, 0.4), inset 0 0 30px rgba(0,0,0,0.6)",
            }}
          >
            <div className="mb-4 sm:mb-6">
              <svg
                className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 mx-auto text-[#E8C068] animate-bounce"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <p className="text-base sm:text-lg text-gray-300 mb-6 sm:mb-8 leading-relaxed max-w-xl mx-auto px-4">
              ...
              shortly with further details and instructions. Please check your
      ...
      {error && !success && (
        <div className="relative z-10 container mx-auto px-4 py-8 min-h-screen flex flex-col items-center justify-center">
          <div
            className="w-full max-w-2xl bg-gradient-to-b from-[#2a0a0a] to-[#0a0a0a] rounded-xl shadow-2xl border-2 sm:border-4 border-red-600 p-6 sm:p-8 md:p-12 text-center animate-fadeIn"
            style={{
              boxShadow:
                "0 0 40px rgba(220, 38, 38, 0.4), inset 0 0 30px rgba(0,0,0,0.6)",
            }}
          >
            <div className="mb-4 sm:mb-6">
              <svg
                className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 mx-auto text-red-500"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
      ...
      {!success && !error && (
        <>
          {!regType ? (
            <div className="relative z-10 container mx-auto px-4 py-8 min-h-screen flex flex-col items-center justify-center animate-fadeIn">
              ...
              <div
                className="w-full max-w-xl bg-gradient-to-b from-[#1a1206] to-[#0a0a0a] rounded-xl shadow-2xl border-2 sm:border-4 border-[#4C1D00] p-6 sm:p-8 space-y-6 text-center"
                style={{
                  boxShadow:
                    "0 0 30px rgba(232, 192, 104, 0.4), inset 0 0 20px rgba(0,0,0,0.6)",
                }}
              >
                <h2 className="text-2xl sm:text-3xl font-bold text-[#E8C068] text-3d mb-2">
                  Select Category
                </h2>
                <p className="text-gray-400 text-sm sm:text-base mb-6">
                  Choose your team type to proceed with the registration.
                </p>
                ...
                <div className="space-y-4">
                  <button
                    ...
                    className="w-full p-5 sm:p-6 bg-[#0a0a0a] border-2 border-[#4C1D00] rounded-lg text-left hover:border-[#FFD700] transition-all transform hover:scale-[1.02] active:scale-[0.98] group flex flex-col gap-1 cursor-pointer"
                    style={{
                      boxShadow: "0 4px 0 rgba(0,0,0,0.5)",
                    }}
                  >
                    <span className="text-lg sm:text-xl font-bold text-[#FFD700] group-hover:text-[#E8C068] transition-colors">
                      1. REGULAR REGISTRATION
                    </span>
                    <span className="text-gray-300 text-xs sm:text-sm">
                      (Teams consisting of members from multiple programs
                      (B.Tech, Diploma, BCA))
                    </span>
                  </button>
                  ...
                  >
                    <span className="text-lg sm:text-xl font-bold text-[#FFD700] group-hover:text-[#E8C068] transition-colors">
                      2. DIPLOMA REGISTRATION
                    </span>
                    <span className="text-gray-300 text-xs sm:text-sm">
                      (Teams consisting exclusively of Diploma students)
                    </span>
                  </button>
                </div>
              </div>
            ...
            <div className="relative z-10 container mx-auto px-4 py-8 min-h-screen flex flex-col items-center justify-center animate-fadeIn">
              ...
              <form
                ...
                style={{
                  boxShadow:
                    "0 0 30px rgba(232, 192, 104, 0.3), inset 0 0 20px rgba(0,0,0,0.5)",
                }}
              >
                <div className="p-4 sm:p-6 md:p-8 space-y-4 sm:space-y-6">
                  ...
                  {currentStep === 1 && (
                    <div className="space-y-6 animate-fadeIn">
                      <h2 className="text-2xl sm:text-3xl font-bold text-[#E8C068] text-3d mb-4">
                        Team Details
                      </h2>
                      <div className="space-y-4">
                        <div>
                          <label className="block text-[#E8C068] font-bold mb-2 text-base sm:text-lg">
                            Team Name
                          </label>
                          <input
                            type="text"
                        ...
                        <div>
                          <label className="block text-[#E8C068] font-bold mb-2 text-lg">
                            College Name
                          </label>
                          <input
                            type="text"
                        ...
                        <div>
                          ...
                          <select
                            value={memberCount}
                            onChange={(e) =>
                              handleMemberCount(Number(e.target.value))
                            }
                            className="w-full px-4 py-3 bg-[#0a0a0a] border-2 border-[#4C1D00] rounded-lg text-white focus:border-[#E8C068] focus:outline-none transition-all"
                          >
                            {[3, 4, 5].map((n) => (
                  ...
                  {currentStep === 3 && (
                    <div className="space-y-6 animate-fadeIn">
                      ...
                      {team.members.map((member, idx) => (
                        <div
                          key={idx}
                          className="p-4 bg-[#0a0a0a] rounded-lg border-2 border-[#4C1D00] space-y-3"
                        >
                          ...
                          <input
                            ...
                            maxLength={10}
                            title="Please enter a valid 10-digit phone number"
                            placeholder={`Member ${idx + 2} Phone Number`}
                            value={member.phone}
                            onChange={(e) => handleChange(e, idx)}
                            className="w-full px-4 py-3 bg-[#1a1206] border-2 border-[#4C1D00] rounded-lg text-white focus:border-[#E8C068] focus:outline-none transition-all"
                          />
                          <input
                            ...
                            minLength={2}
                            maxLength={50}
                            placeholder={`Member ${idx + 2} Department (e.g. CSE)`}
                  ...
                  {currentStep === 4 && (
                    <div className="space-y-6 animate-fadeIn">
                      ...
                      <div className="bg-[#0a0a0a] p-6 rounded-lg border-2 border-[#4C1D00] text-center">
                        <p className="text-[#E8C068] mb-4 text-lg">
                        ...
                        />
                        {fileError && (
                          <p className="mt-2 text-red-500 font-bold text-sm">
                            {fileError}
                          </p>
                        )}
                      ...
                      <div className="bg-[#0a0a0a] p-6 rounded-lg border-2 border-[#4C1D00]">
                        <div className="flex items-start gap-3">
                          ...
                          <label
                            ...
                            className="text-[#E8C068] font-bold text-sm sm:text-base"
                          >
                ...
                <div className="bg-[#0a0a0a] p-4 sm:p-6 border-t-2 sm:border-t-4 border-[#4C1D00] flex justify-between items-center">
                  {!success &&
                    (currentStep > 1 || (currentStep === 1 && regType)) && (
                      <button
                        type="button"
                        onClick={() => {
                          playClickSound();
                        ...
                        className="px-4 sm:px-6 md:px-8 py-2 sm:py-3 bg-gradient-to-b from-[#FFD700] to-[#E8C068] hover:from-[#E8C068] hover:to-[#D4AF37] text-[#1a1206] font-bold text-sm sm:text-base rounded-lg border-2 border-[#4C1D00] transition-all transform hover:scale-105 active:scale-95"
                        style={{
                          boxShadow:
                            "0 4px 0 #4C1D00, 0 8px 15px rgba(232,192,104,0.5)",
                          textShadow: "1px 1px 0 rgba(0,0,0,0.3)",
                        }}
                      >
                        BACK
      ...
      {showTermsModal && (
        ...
        >
          <motion.div
            ...
            style={{
              boxShadow:
                "0 0 40px rgba(232, 192, 104, 0.5), inset 0 0 30px rgba(0,0,0,0.6)",
            }}
          >
            {/* Header */}
              ...
              <div className="space-y-4 text-gray-300 text-sm sm:text-base">
                <div className="bg-[#0a0a0a] p-4 rounded-lg border-2 border-[#4C1D00]">
                  ...
                  <p className="ml-4 mt-2">
                    Teams must consist of a minimum of 3 and a maximum of 5
                    participants.
                  </p>
                </div>
                <div className="bg-[#0a0a0a] p-4 rounded-lg border-2 border-[#4C1D00]">
                  ...
                  <p className="ml-4 mt-2">
                    ...
                    <span className="text-[#E8C068] font-bold text-xl">
                      ₹800
                    </span>{" "}
                    per team is required for entry.
                  </p>
                </div>
                <div className="bg-[#0a0a0a] p-4 rounded-lg border-2 border-[#4C1D00]">
                  <span className="text-[#FFD700] font-bold text-lg">
                  ...
                  <p className="ml-4 mt-2">
                    A clear screenshot or proof of payment must be attached
                    during registration.
                  </p>
                </div>
                <div className="bg-[#0a0a0a] p-4 rounded-lg border-2 border-[#4C1D00]">
                  ...
                  <p className="ml-4 mt-2">
                    Participants must bring their consent form filled in the
                    form of Hard Copy.
                  </p>
                </div>
                <div className="bg-[#0a0a0a] p-4 rounded-lg border-2 border-[#4C1D00]">
                  ...
                  <p className="ml-4 mt-2">
                    Participants must be currently enrolled university/college
                    students.
                  </p>
                </div>
                <div className="bg-[#0a0a0a] p-4 rounded-lg border-2 border-[#4C1D00]">
                  ...
                  <p className="ml-4 mt-2">
                    All submitted projects must be original work created
                    entirely during the 24-hour hackathon period.
                  </p>
                </div>
                <div className="bg-[#0a0a0a] p-4 rounded-lg border-2 border-[#4C1D00]">
                  <span className="text-[#FFD700] font-bold text-lg">
                ...
                <div className="bg-[#0a0a0a] p-4 rounded-lg border-2 border-[#4C1D00]">
                  ...
                  <p className="ml-4 mt-2">
                    Teams retain the intellectual property rights to their
                    creations.
                  </p>
                </div>
                <div className="bg-[#0a0a0a] p-4 rounded-lg border-2 border-[#4C1D00]">
            ...
            <div className="bg-[#0a0a0a] p-4 sm:p-6 border-t-4 border-[#4C1D00] flex justify-center">
              <button
                ...
                style={{
                  boxShadow:
                    "0 6px 0 #4C1D00, 0 10px 20px rgba(232,192,104,0.5)",
                  textShadow: "1px 1px 0 rgba(0,0,0,0.3)",
                }}
              >
                I UNDERSTAND
